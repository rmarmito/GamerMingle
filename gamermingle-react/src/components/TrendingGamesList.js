...
const TrendingGamesList = () => {
  ...
  const games = [
    ...
    },
    {
      ...
      imageUrl:
        "https://cdn.cloudflare.steamstatic.com/apps/csgo/images/csgo_react/global/logo_cs_sm_blk.svg",
    ...
    },
    {
      ...
      name: "Lethal Company",
      imageUrl:
        "https://cdn.cloudflare.steamstatic.com/steam/apps/1966720/header.jpg?t=1700231592",
    ...
    },
    {
      ...
      name: "Fortnite",
      imageUrl:
        "https://cdn2.unrealengine.com/blade-2560x1440-2560x1440-6b1174ff6f66.jpg",
  ...
  return (
    <div className="trending-games-section">
      ...
      <div className="trending-games-list" style={{ paddingBottom: "100px" }}>
        {games.map((game) => (
          <a
            key={game.id}
            href={game.url}
